...
borpo = User.create(username: 'borpo', password_digest: BCrypt::Password.create('password'), email: 'borpo@fake.com')
borpo.save
Post.create(content: 'borpo will destroy you', user: borpo)
Post.create(content: 'borpo just had a mimosa', user: borpo)

ladyShellington = User.create(username: 'LadyShellington', password_digest: BCrypt::Password.create('chicken'), email: 'chicken@hen.com')
